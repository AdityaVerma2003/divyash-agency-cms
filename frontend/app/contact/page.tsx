            ...
            <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6">
              ...
              <a href="tel:+919958915844"
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-[var(--ink)] group-hover:text-coral-500 transition-colors">+91 99589 15844</p>
                </div>
              </a>
              ...
              <a href="tel:+919266452049"
                ...
                <div>
                  <p className="text-xs text-[var(--muted)] mb-0.5">Alternate</p>
